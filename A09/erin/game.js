...
*/
var SPECIAL_GREEN = 0xa6db70;
var OTHER_GREEN = 0x5a783c;

PS.init = function( system, options ) {

	// Establish grid dimensions
	
	PS.gridSize( 16, 16 ); //I made the grid bigger
	
	// Set background color to Perlenspiel logo gray
	
	PS.gridColor( SPECIAL_GREEN ); //changed background color
	
	// Change status line color and text

	PS.statusColor( OTHER_GREEN ); //changed status text color
	PS.statusText( "Draw a Picture" ); //changed text color
...
PS.touch = function( x, y, data, options ) {
	...
	//made colors rotate between white, black and the light green
